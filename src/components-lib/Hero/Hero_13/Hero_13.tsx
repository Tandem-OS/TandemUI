...
import { type Hero_13Props, defaultColors } from './Hero_13.types';
...
const useComponentStyles = (colors: Hero_13Props['colors'], theme: 'light' | 'dark') => {
    return useMemo(() => {
 ...
 */
const Hero_13: React.FC<Hero_13Props> = ({
        ...
        <section className={`relative w-full min-h-screen lg:h-screen lg:overflow-hidden ${className}`}>
            ...
            <div className="relative z-10 w-full h-full min-h-screen lg:h-screen py-2xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 h-[85vh] lg:h-full">
                    {/* Mobile: Heading & CTAs Top Centered / Desktop: Description Bottom (Left Column) */}
                    <div className="order-1 lg:order-1 px-lg pb-xl lg:px-2xl xl:px-3xl 2xl:px-4xl pt-lg lg:pt-xl xl:pt-2xl lg:flex lg:items-end lg:pb-xl">
                        {/* Mobile Heading & CTAs (visible on mobile only) */}
                        <motion.div
                            className="w-full lg:hidden space-y-md lg:space-y-lg"
                    ...
                    {/* Mobile: Description Bottom / Desktop: Heading & CTAs Center (Right Column) */}
                    <div className="order-2 lg:order-2 flex items-end lg:items-center px-lg pb-xl lg:px-2xl xl:px-2xl 2xl:px-4xl lg:pb-xl pt-lg lg:pt-xl">
