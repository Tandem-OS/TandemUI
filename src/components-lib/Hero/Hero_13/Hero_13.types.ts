/**
 * Color configuration for Hero_13 - Background hero with overlay
 */
export interface Hero_13Colors {
...
export interface Hero_13Props {
  ...
  colors?: Hero_13Colors;
}

/**
 * Default color configuration for Hero_13
 */
export const defaultColors: Hero_13Colors = {
  overlay: {
