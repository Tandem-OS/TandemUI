...
export function validateHero25Props(props: Hero_25Props): ValidationResult {
...
export function sanitizeProps(props: Hero_25Props): Hero_25Props {
...
export function validateLayoutSafety(props: Hero_25Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
