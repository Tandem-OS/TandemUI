/**
 * Color configuration for Hero_19
 */
export interface Hero_19Colors {
    background?: {
        light?: string;
        dark?: string;
    };
...
export interface Hero_19Props {
    ...
    colors?: Hero_19Colors;
}

/**
 * Default color configuration for Hero_19
 */
export const defaultColors: Hero_19Colors = {
    background: {
        light: '#ffffff',
        dark: '#0f172a'
    },
