...
import { type Hero_19Props, defaultColors } from './Hero_19.types';
...
const useComponentStyles = (colors: Hero_19Props['colors'], theme: 'light' | 'dark') => {
    return useMemo(() => {
 ...
 * Hero_19 Component
 */
const Hero_19: React.FC<Hero_19Props> = ({
