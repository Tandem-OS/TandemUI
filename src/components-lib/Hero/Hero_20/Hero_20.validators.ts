...
export function validateHero20Props(props: Hero_20Props): ValidationResult {
...
export function sanitizeProps(props: Hero_20Props): Hero_20Props {
...
export function validateLayoutSafety(props: Hero_20Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
