// Hero_05.meta.ts
import { type Hero_05Meta } from './Hero_05.types';

const meta: Hero_05Meta = {
  version: "1.1",
  ...
  category: "hero",
  intent: "convert",
  layout_structure: "split-video", // Key difference: includes video player
  ...
  accessibility: {
    ...
    screenReaderHints: {
      ...
      section: "Main hero content with video"
    }
  },
  ...
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/05 - Split with Video",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_05Props, type ColorOverrides } from './Hero_05.types';",
      "import { validateHero05Props, sanitizeProps, formatValidationMessage } from './Hero_05.validators';",
      "import meta from './Hero_05.meta';"
    ],
    template: `const Hero_05: React.FC<Hero_05Props> = (props = {}) => {
    const { theme } = useTheme();
    const validation = validateHero05Props(props);
    ...
    return (
        <section
            ...
            role="banner"
            aria-label="Main hero content with video"
        >
  ...
  development: {
    ...
    documentation: {
      designNotes: "Primary conversion component for landing pages with integrated video player. All styles are tokenized using native HTML elements. Fully independent with no component dependencies.",
