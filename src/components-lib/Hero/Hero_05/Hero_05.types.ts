// src/components-lib/Hero/Hero_05/Hero_05.types.ts

/**
 * Color configuration for Hero_05 with Video support
 */
export interface Hero_05Colors {
  background?: {
    light?: string;
    dark?: string;
  };
...
export interface Hero_05Props {
  ...
  colors?: Hero_05Colors;
}

/**
 * Default color configuration for Hero_05
 */
export const defaultColors: Hero_05Colors = {
  background: {
    light: '#ffffff',
    dark: '#0f172a'
  },
