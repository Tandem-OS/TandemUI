/**
 * Color configuration for Hero_16 with Video background support
 */
export interface Hero_16Colors {
...
export interface Hero_16Props {
    ...
    colors?: Hero_16Colors;
}

/**
 * Default color configuration for Hero_16
 */
export const defaultColors: Hero_16Colors = {
    overlay: {
