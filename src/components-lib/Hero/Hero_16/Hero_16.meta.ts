// Hero_16.meta.ts
import { type Hero_16Meta } from './Hero_16.types';

const meta: Hero_16Meta = {
  version: "1.1",
  ...
  category: "hero",
  intent: "information",
  layout_structure: "video_background_heading_cta_left_bottom_paragraph_right_top",

  // === Tokens ===
  tokens: {
    // Layout Structure - Video background hero with heading & CTAs left bottom, paragraph right top
    layout: {
      ...
      leftColumn: "order-1 lg:order-1 flex items-start lg:items-end", // Left column has heading & CTAs at bottom
      rightColumn: "order-2 lg:order-2 px-lg pb-sm lg:pb-xl lg:px-2xl xl:px-3xl 2xl:px-4xl pt-sm lg:pt-xl flex items-end lg:items-start", // Right column has paragraph at top
      leftContent: "w-full space-y-md lg:space-y-lg", // Heading & CTAs styling for left column
      rightContent: "w-full" // Paragraph styling for right column
    },

    // Responsive Spacing - Optimized for video background with heading & CTA positioning
    spacing: {
  ...
  props: {
    title: {
      ...
      required: false,
      max: 80,
      placeholder: "Enter your informative headline",
  ...
  defaults: {
    ...
    // Default Colors for Video Background Hero (Heading & CTAs Left Bottom, Paragraph Right Top)
    colors: {
      overlay: {
  ...
  // === Layout Contract ===
  layoutContract: {
    grid: "2-col-video-bg-heading-cta-left-paragraph-right",
    maxWidth: "full",
  ...
  accessibility: {
    landmarks: ["banner"],
    ariaHints: ["h1 positioned left bottom", "video background decorative", "video controls accessible", "overlay for readability"],
    colorContrastMin: 4.5,
    focusManagement: "linear",
    keyboardNavigation: true,
    screenReaderHints: {
      video: "decorative background video",
      section: "Main hero content with video background, heading and actions positioned left bottom",
  ...
  generation: {
    aiPromptHints: [
      "Informational video background hero component with structured content positioning",
      ...
      "Heading and CTAs positioned at bottom left, paragraph at top right"
    ],
    contentConstraints: {
      title: {
        tone: ["informative", "professional", "clear"],
        avoid: ["overly casual", "weak words"],
        maxSentences: 1
      },
      description: {
        tone: ["informative", "supportive", "clear"],
  ...
  // === Semantic Profile ===
  semanticProfile: {
    primaryConcepts: ["information-delivery", "video-presentation", "professional-impact", "content-organization"],
    contentTypes: ["hero-messaging", "video-content", "cta-copy"],
    embeddingWeights: { visual: 0.5, copy: 0.3, interaction: 0.2 },
    contextualRelevance: ["landing-page-video", "corporate-showcase", "information-presentation", "business-content"]
  },

  // === Figma Export ===
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/16 - Video Background Heading CTA Left Paragraph Right",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_16Props, type ColorOverrides } from './Hero_16.types';",
      "import { validateHero16Props, sanitizeProps, formatValidationMessage } from './Hero_16.validators';",
      "import meta from './Hero_16.meta';"
    ],
    template: `const Hero_16: React.FC<Hero_16Props> = (props = {}) => {
    const { theme } = useTheme();
    const uniqueId = useId();
    const videoRef = useRef<HTMLVideoElement>(null);
    const [isPlaying, setIsPlaying] = useState(false);
    
    const validation = validateHero16Props(props);
            ...
            <div className={meta.tokens.layout.contentContainer}>
                <div className={meta.tokens.spacing.sectionY}>
                    <div className={meta.tokens.layout.grid}>
                        {/* Left Column - Heading & CTAs at Bottom */}
  ...
  development: {
    ...
    documentation: {
      designNotes: "Informational video background hero with heading & CTAs positioned at left bottom, paragraph at right top. All styles tokenized using native HTML elements. Features video player with play/pause controls and customizable overlay.",
