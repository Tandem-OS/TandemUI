...
// Main Hero_11 component
const Hero_11: React.FC<Hero_11Props> = (props = {}) => {
    ...
    if (process.env.NODE_ENV === 'development') {
        if (!validation.valid || validation.warnings) {
            console.group('Hero_11 Validation');
    ...
    return (
        <section
            ...
            role="banner"
            aria-label={meta.accessibility.screenReaderHints?.section || "Main hero content with fixed positioning layout"}
            id={uniqueId}
        >
            {/* Background Image */}
            <div
            ...
            <div className={`${meta.tokens.layout.contentContainer} ${meta.tokens.spacing.sectionY}`}>
                <div className={meta.tokens.layout.grid}>
                    {/* Left Column - Heading & CTAs (Fixed Position) */}
                    <div className={meta.tokens.layout.leftColumn} data-testid="hero-left-column">
                        <MotionWrapper
                            ...
                            data-testid="hero-heading-cta-wrapper"
                        >
                            {/* Heading */}
                            <h1
                    ...
                    {/* Right Column - Description (Fixed Position) */}
                    <div className={meta.tokens.layout.rightColumn} data-testid="hero-right-column">
                        <MotionWrapper
                            ...
                            data-testid="hero-description-wrapper"
                        >
                            {/* Description */}
                            <p
