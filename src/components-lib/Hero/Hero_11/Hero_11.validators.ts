...
export function validateHero11Props(props: Hero_11Props): ValidationResult {
...
export function sanitizeProps(props: Hero_11Props): Hero_11Props {
...
export function validateLayoutSafety(props: Hero_11Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
