...
// === Token Structure ===
export interface Hero_23Tokens {
...
// === Defaults ===
export interface Hero_23Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_23PropsSchema = {
    [K in keyof Required<Hero_23Props>]: PropDefinition<Hero_23Props[K]>;
};

// === Meta ===
export interface Hero_23Meta extends MetaV1_1<Hero_23Defaults, Hero_23Tokens> {
    component_id: "Hero_23";
    category: "hero";
    intent: "information";
    layout_structure: "content-top-video-bottom";
    props: Hero_23PropsSchema;
    defaults: Hero_23Defaults;
    tokens: Hero_23Tokens;
    variants: Variant<Partial<Hero_23Props>, DeepPartial<Hero_23Tokens>>[];
}
...
export function isHero_23Props(obj: unknown): obj is Hero_23Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
// === Utility Types ===
export type Hero_23PropsKeys = keyof Hero_23Props;
export type Hero_23TokenKeys = keyof Hero_23Tokens;

export type Hero_23PropsPatch = Partial<Hero_23Props>;
export type Hero_23TokensPatch = DeepPartial<Hero_23Tokens>;

export interface ValidationResult<T = Hero_23Props> {
    valid: boolean;
    errors: string[];
    data?: T;
}

export type SanitizedHero_23Props = Required<Hero_23Props>;

export interface Hero_23BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_23GenerationContext {
    props: Partial<Hero_23Props>;
    tokens: Partial<Hero_23Tokens>;
    brand: Hero_23BrandContext;
