/**
 * Color configuration for Hero_23 with Video support
 */
export interface Hero_23Colors {
    background?: {
        light?: string;
        dark?: string;
    };
...
export interface Hero_23Props {
    ...
    colors?: Hero_23Colors;
}

/**
 * Default color configuration for Hero_23
 */
export const defaultColors: Hero_23Colors = {
    background: {
        light: '#ffffff',
        dark: '#0f172a'
    },
