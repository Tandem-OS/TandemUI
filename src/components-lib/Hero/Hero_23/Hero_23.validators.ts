...
export function validateHero23Props(props: Hero_23Props): ValidationResult {
...
export function sanitizeProps(props: Hero_23Props): Hero_23Props {
...
export function validateLayoutSafety(props: Hero_23Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
