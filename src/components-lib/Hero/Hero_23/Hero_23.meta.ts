// Hero_23.meta.ts
import { type Hero_23Meta } from './Hero_23.types';

const meta: Hero_23Meta = {
  version: "1.1",
  ...
  category: "hero",
  intent: "information",
  layout_structure: "content-top-video-bottom", // Key difference: content above video
  ...
  tokens: {
    ...
    spacing: {
      ...
      contentSpacing: "space-y-md lg:space-y-lg max-w-2xl mx-auto",
  ...
  accessibility: {
    ...
    screenReaderHints: {
      ...
      section: "Main hero content with centered video below"
    }
  },
  ...
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/23 - Content Above Video",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_23Props, type ColorOverrides } from './Hero_23.types';",
      "import { validateHero23Props, sanitizeProps, formatValidationMessage } from './Hero_23.validators';",
      "import meta from './Hero_23.meta';"
    ],
    template: `const Hero_23: React.FC<Hero_23Props> = (props = {}) => {
    const { theme } = useTheme();
    const validation = validateHero23Props(props);
    ...
    return (
        <section
            ...
            role="banner"
            aria-label="Main hero content with video below"
        >
            <div className={\`\${meta.tokens.layout.contentContainer} \${meta.tokens.spacing.containerX} \${meta.tokens.spacing.containerY}\`}>
                <div className={\`max-w-2xl mx-auto \${meta.tokens.spacing.contentSpacing}\`}>
                    <h1
  ...
  development: {
    ...
    documentation: {
      designNotes: "Information-focused component for landing pages with centered content above full-width video. All styles are tokenized using native HTML elements. Fully independent with no component dependencies.",
