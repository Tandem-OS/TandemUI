/**
 * Color configuration for Hero_12 - Background hero with overlay
 */
export interface Hero_12Colors {
...
export interface Hero_12Props {
  ...
  colors?: Hero_12Colors;
}

/**
 * Default color configuration for Hero_12
 */
export const defaultColors: Hero_12Colors = {
  overlay: {
