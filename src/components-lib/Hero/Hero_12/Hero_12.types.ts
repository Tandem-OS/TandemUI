...
// === Token Structure ===
export interface Hero_12Tokens {
    ...
    layout: {
        ...
        grid: string;
        leftColumn: string; // Mobile: heading/CTAs top, Desktop: heading/CTAs center
        rightColumn: string; // Mobile: description bottom, Desktop: description bottom
...
// === Defaults ===
export interface Hero_12Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_12PropsSchema = {
    [K in keyof Required<Hero_12Props>]: PropDefinition<Hero_12Props[K]>;
};

// === Meta ===
export interface Hero_12Meta extends MetaV1_1<Hero_12Defaults, Hero_12Tokens> {
    component_id: "Hero_12";
    category: "hero";
    intent: "convert";
    layout_structure: "background_center_bottom";
    props: Hero_12PropsSchema;
    defaults: Hero_12Defaults;
    tokens: Hero_12Tokens;
    variants: Variant<Partial<Hero_12Props>, DeepPartial<Hero_12Tokens>>[];
}
...
export function isHero_12Props(obj: unknown): obj is Hero_12Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
// === Utility Types ===
export type Hero_12PropsKeys = keyof Hero_12Props;
export type Hero_12TokenKeys = keyof Hero_12Tokens;

export type Hero_12PropsPatch = Partial<Hero_12Props>;
export type Hero_12TokensPatch = DeepPartial<Hero_12Tokens>;

export interface ValidationResult<T = Hero_12Props> {
    valid: boolean;
    errors: string[];
    data?: T;
}

export type SanitizedHero_12Props = Required<Hero_12Props>;

export interface Hero_12BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_12GenerationContext {
    props: Partial<Hero_12Props>;
    tokens: Partial<Hero_12Tokens>;
    brand: Hero_12BrandContext;
    layout?: "center_bottom" | "centered";
    variant?: string;
