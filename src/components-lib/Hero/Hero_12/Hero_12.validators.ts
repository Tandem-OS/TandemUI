...
export function validateHero12Props(props: Hero_12Props): ValidationResult {
...
export function sanitizeProps(props: Hero_12Props): Hero_12Props {
...
export function validateLayoutSafety(props: Hero_12Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
