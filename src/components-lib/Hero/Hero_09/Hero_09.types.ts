/**
 * Color configuration for Hero_09 - Background hero with overlay
 */
export interface Hero_09Colors {
...
export interface Hero_09Props {
  ...
  colors?: Hero_09Colors;
}

/**
 * Default color configuration for Hero_09
 */
export const defaultColors: Hero_09Colors = {
  overlay: {
