...
describe('Hero_09 - Token Usage Validation', () => {
  let sourceCode: string;

  beforeAll(() => {
    const componentPath = path.join(__dirname, 'Hero_09.tsx');
  ...
  it('should only import from local meta file', () => {
    ...
    const invalidImports = importStatements.filter(imp => {
      return imp.includes('tokens/') ||
        ...
        (imp.includes('meta') && !imp.includes('./Hero_09.meta'));
    });
  ...
  it('should have proper background hero structure', () => {
    const { container } = render(
      <Hero_09
        title="Test Title"
        description="Test Description"
