...
export function validateHero09Props(props: Hero_09Props): ValidationResult {
...
export function sanitizeProps(props: Hero_09Props): Hero_09Props {
...
export function validateLayoutSafety(props: Hero_09Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
