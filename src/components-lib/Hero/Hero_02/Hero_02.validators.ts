...
export function validateHero02Props(props: Hero_02Props): ValidationResult {
...
export function sanitizeProps(props: Hero_02Props): Hero_02Props {
...
export function validateLayoutSafety(props: Hero_02Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
