// Hero_22.meta.ts
import { type Hero_22Meta } from './Hero_22.types';

const meta: Hero_22Meta = {
  version: "1.1",
  ...
  // === Tokens ===
  tokens: {
    // Layout Structure - Left-aligned content above full-width image with newsletter
    layout: {
      section: "w-full",
    ...
    // Responsive Spacing - Optimized for left-aligned content with newsletter
    spacing: {
  ...
  defaults: {
    ...
    // Default Colors for Left-Aligned Content Hero with Newsletter
    colors: {
      background: {
        light: '#ffffff',
        dark: '#0f172a'
  ...
  // === Layout Contract ===
  layoutContract: {
    grid: "single-col-left-content-above-image-newsletter",
    maxWidth: "container",
  ...
  accessibility: {
    ...
    ariaHints: ["h1 left-aligned above image", "Newsletter form accessible", "descriptive alt text required"],
    colorContrastMin: 4.5,
    focusManagement: "linear",
    keyboardNavigation: true,
    screenReaderHints: {
      section: "Main hero content with left-aligned text and newsletter signup above full-width image",
  ...
  generation: {
    aiPromptHints: [
      "Left-aligned hero component with lead capture focus",
      "Above-the-fold placement with newsletter signup",
      "Business-oriented presentation suitable for SaaS/B2B",
      "Newsletter form integrated for conversion",
    ...
    contentConstraints: {
      ...
      newsletterText: {
        tone: ["action-oriented", "friendly", "trustworthy"],
  ...
  // === Semantic Profile ===
  semanticProfile: {
    primaryConcepts: ["lead-capture", "newsletter-signup", "business-focused", "professional-presentation", "left-aligned-content"],
    contentTypes: ["hero-messaging", "business-content", "newsletter-copy", "conversion-copy"],
    embeddingWeights: { visual: 0.3, copy: 0.4, interaction: 0.3 },
    contextualRelevance: ["landing-page", "saas-site", "business-portfolio", "lead-generation", "newsletter-signup"]
  },

  // === Figma Export ===
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/22 - Left-Aligned Content Above Image with Newsletter",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_22Props, type ColorOverrides } from './Hero_22.types';",
      "import { validateHero22Props, sanitizeProps, formatValidationMessage } from './Hero_22.validators';",
      "import meta from './Hero_22.meta';"
    ],
    template: `const Hero_22: React.FC<Hero_22Props> = (props = {}) => {
                ...
                <div className={meta.tokens.spacing.sectionPadding}>
                    <div className={meta.tokens.layout.contentWrapper}>
                        <div className={meta.tokens.spacing.contentSpacing}>
                            ...
                            <div className={meta.tokens.spacing.newsletterSpacing}>
  ...
  development: {
    ...
    documentation: {
      designNotes: "Left-aligned hero with business focus and newsletter signup integration. All styles tokenized using native HTML elements. Perfect for SaaS and B2B lead generation.",
      usageGuidelines: "Use native h1, p, form, input, button, img elements with complete token classes. Newsletter form integrated directly. Colors are fully customizable via props."
    }
  }
};
