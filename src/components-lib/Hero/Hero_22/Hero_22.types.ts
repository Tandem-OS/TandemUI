/**
 * Color configuration for Hero_22 with Newsletter support
 */
export interface Hero_22Colors {
    background?: {
        light?: string;
        dark?: string;
    };
...
export interface Hero_22Props {
    ...
    colors?: Hero_22Colors;
}

/**
 * Default color configuration for Hero_22
 */
export const defaultColors: Hero_22Colors = {
    background: {
        light: '#ffffff',
        dark: '#0f172a'
    },
