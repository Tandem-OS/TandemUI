...
export function validateHero22Props(props: Hero_22Props): ValidationResult {
...
export function sanitizeProps(props: Hero_22Props): Hero_22Props {
...
export function validateLayoutSafety(props: Hero_22Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
