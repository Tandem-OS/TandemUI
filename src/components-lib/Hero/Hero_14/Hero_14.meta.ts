// Hero_14.meta.ts
import { type Hero_14Meta } from './Hero_14.types';

const meta: Hero_14Meta = {
  version: "1.1",
  ...
  // === Tokens ===
  tokens: {
    // Layout Structure - Video background hero with two columns
    layout: {
      ...
      leftColumn: "order-1 lg:order-1 lg:flex lg:items-start",
      rightColumn: "order-2 lg:order-2 flex items-end",
      rightContent: "w-full space-y-md lg:space-y-lg"
    },

    // Responsive Spacing - Optimized for video background
    spacing: {
      sectionY: "py-md lg:py-2xl",
      leftPadding: "px-lg pb-sm lg:pb-xl lg:px-2xl xl:px-3xl 2xl:px-4xl pt-sm lg:pt-xl xl:pt-2xl",
      rightPadding: "px-lg pb-sm lg:pb-xl lg:px-2xl xl:px-2xl 2xl:px-4xl pt-sm lg:pt-xl",
  ...
  defaults: {
    ...
    // Default Colors for Video Background Hero
    colors: {
      overlay: {
  ...
  accessibility: {
    landmarks: ["banner"],
    ariaHints: ["h1 first", "video background decorative", "video controls accessible", "overlay for readability"],
    colorContrastMin: 4.5,
    focusManagement: "linear",
    keyboardNavigation: true,
    screenReaderHints: {
      video: "decorative background video",
      section: "Main hero content with video background",
  ...
  generation: {
    aiPromptHints: [
      "Cinematic video background hero component",
  ...
  // === Semantic Profile ===
  semanticProfile: {
    primaryConcepts: ["conversion", "video-presentation", "cinematic-impact", "brand-storytelling"],
  ...
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/14 - Video Background Two Column",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_14Props, type ColorOverrides } from './Hero_14.types';",
      "import { validateHero14Props, sanitizeProps, formatValidationMessage } from './Hero_14.validators';",
      "import meta from './Hero_14.meta';"
    ],
    template: `const Hero_14: React.FC<Hero_14Props> = (props = {}) => {
    const { theme } = useTheme();
    const uniqueId = useId();
    const videoRef = useRef<HTMLVideoElement>(null);
    const [isPlaying, setIsPlaying] = useState(false);
    
    const validation = validateHero14Props(props);
  ...
  development: {
    ...
    documentation: {
      designNotes: "Cinematic video background hero with two-column layout. All styles tokenized using native HTML elements. Features video player with play/pause controls and customizable overlay.",
