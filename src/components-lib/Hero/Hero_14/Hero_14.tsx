...
// Play Button SVG Icons (removed - using react-icons instead)
...
// Main Hero_14 component
const Hero_14: React.FC<Hero_14Props> = (props = {}) => {
    ...
    if (process.env.NODE_ENV === 'development') {
        if (!validation.valid || validation.warnings) {
            console.group('Hero_14 Validation');
    ...
    return (
        <section
            ...
            role="banner"
            aria-label={meta.accessibility.screenReaderHints?.section || "Main hero content with video background"}
            id={uniqueId}
        >
            {/* Background Video */}
            <div
