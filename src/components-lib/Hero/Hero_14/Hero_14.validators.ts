...
export function validateHero14Props(props: Hero_14Props): ValidationResult {
    ...
    // 8. Enhanced color validation (similar to Hero_09 but with video play button colors)
...
export function sanitizeProps(props: Hero_14Props): Hero_14Props {
...
export function validateLayoutSafety(props: Hero_14Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
