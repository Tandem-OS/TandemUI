/**
 * Color configuration for Hero_14 with Video background support
 */
export interface Hero_14Colors {
...
export interface Hero_14Props {
    ...
    colors?: Hero_14Colors;
}

/**
 * Default color configuration for Hero_14
 */
export const defaultColors: Hero_14Colors = {
    overlay: {
