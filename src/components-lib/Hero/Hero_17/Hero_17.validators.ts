...
export function validateHero17Props(props: Hero_17Props): ValidationResult {
...
export function sanitizeProps(props: Hero_17Props): Hero_17Props {
...
export function validateLayoutSafety(props: Hero_17Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
