// Hero_17.meta.ts
import { type Hero_17Meta } from './Hero_17.types';

const meta: Hero_17Meta = {
  version: "1.1",
  ...
  // === Tokens ===
  tokens: {
    // Layout Structure - Video background hero with heading & CTAs left center, paragraph right bottom
    layout: {
      ...
      leftColumn: "order-1 lg:order-1 flex lg:items-center", // Left column has heading & CTAs at center
      rightColumn: "order-2 lg:order-2 flex items-end px-lg pb-sm lg:pb-xl lg:px-2xl xl:px-3xl 2xl:px-4xl pt-sm lg:pt-xl", // Right column has paragraph at bottom
    ...
    // Responsive Spacing - Optimized for video background with center/bottom positioning
    spacing: {
  ...
  defaults: {
    ...
    // Default Colors for Video Background Hero (Heading & CTAs Left Center, Paragraph Right Bottom)
    colors: {
      overlay: {
  ...
  // === Layout Contract ===
  layoutContract: {
    grid: "2-col-video-bg-heading-cta-center-paragraph-bottom",
    maxWidth: "full",
  ...
  accessibility: {
    landmarks: ["banner"],
    ariaHints: ["h1 positioned left center", "video background decorative", "video controls accessible", "overlay for readability"],
    colorContrastMin: 4.5,
    focusManagement: "linear",
    keyboardNavigation: true,
    screenReaderHints: {
      video: "decorative background video",
      section: "Main hero content with video background, heading and actions positioned left center",
  ...
  generation: {
    aiPromptHints: [
      "Engaging video background hero component with creative content positioning",
      ...
      "Heading and CTAs positioned at left center, paragraph at right bottom"
    ],
    contentConstraints: {
      title: {
        tone: ["engaging", "creative", "bold"],
  ...
  // === Semantic Profile ===
  semanticProfile: {
    primaryConcepts: ["engagement", "video-presentation", "creative-impact", "dynamic-storytelling"],
    contentTypes: ["hero-messaging", "video-content", "cta-copy"],
    embeddingWeights: { visual: 0.5, copy: 0.3, interaction: 0.2 },
    contextualRelevance: ["landing-page-video", "creative-showcase", "engagement-presentation", "portfolio-content"]
  },

  // === Figma Export ===
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/17 - Video Background Heading CTA Center Paragraph Bottom",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_17Props, type ColorOverrides } from './Hero_17.types';",
      "import { validateHero17Props, sanitizeProps, formatValidationMessage } from './Hero_17.validators';",
      "import meta from './Hero_17.meta';"
    ],
    template: `const Hero_17: React.FC<Hero_17Props> = (props = {}) => {
  ...
  development: {
    ...
    documentation: {
      designNotes: "Creative video background hero with heading & CTAs positioned at left center, paragraph at right bottom. All styles tokenized using native HTML elements. Features video player with play/pause controls and customizable overlay.",
