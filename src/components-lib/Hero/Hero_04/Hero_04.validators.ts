...
export function validateHero04Props(props: Hero_04Props): ValidationResult {
...
export function sanitizeProps(props: Hero_04Props): Hero_04Props {
...
export function validateLayoutSafety(props: Hero_04Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
