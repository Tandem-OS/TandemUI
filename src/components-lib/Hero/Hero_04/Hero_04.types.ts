...
export interface Hero_04Tokens {
...
export interface Hero_04Defaults {
    title: string;
    description: string;
    newsletterPlaceholder: string;
    newsletterButtonText: string;
...
// === Props Schema ===
export type Hero_04PropsSchema = {
    [K in keyof Required<Hero_04Props>]: PropDefinition<Hero_04Props[K]>;
};

// === Meta ===
export interface Hero_04Meta extends MetaV1_1<Hero_04Defaults, Hero_04Tokens> {
    component_id: "Hero_04";
    category: "hero";
    intent: "capture-leads";
    layout_structure: "split-newsletter-reverse";
    props: Hero_04PropsSchema;
    defaults: Hero_04Defaults;
    tokens: Hero_04Tokens;
    variants: Variant<Partial<Hero_04Props>, DeepPartial<Hero_04Tokens>>[];
}
...
export function isHero_04Props(obj: unknown): obj is Hero_04Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
export type Hero_04PropsKeys = keyof Hero_04Props;
export type Hero_04TokenKeys = keyof Hero_04Tokens;

// For variant creation
export type Hero_04PropsPatch = Partial<Hero_04Props>;
export type Hero_04TokensPatch = DeepPartial<Hero_04Tokens>;

// For validation results
export interface ValidationResult<T = Hero_04Props> {
    valid: boolean;
    errors: string[];
    data?: T;
}
...
// For sanitized props
export type SanitizedHero_04Props = Required<Hero_04Props>;

// Brand context for AI generation
export interface Hero_04BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_04GenerationContext {
    props: Partial<Hero_04Props>;
    tokens: Partial<Hero_04Tokens>;
    brand: Hero_04BrandContext;
