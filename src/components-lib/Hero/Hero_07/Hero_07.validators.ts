...
export function validateHero07Props(props: Hero_07Props): ValidationResult {
...
export function sanitizeProps(props: Hero_07Props): Hero_07Props {
...
export function validateLayoutSafety(props: Hero_07Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
