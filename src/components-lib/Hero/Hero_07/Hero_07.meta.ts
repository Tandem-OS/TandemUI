// Hero_07.meta.ts
import { type Hero_07Meta } from './Hero_07.types';

const meta: Hero_07Meta = {
  version: "1.1",
  ...
  layout_structure: "split-newsletter-video", // Key difference: newsletter left, video right
  ...
  tokens: {
    ...
    layout: {
      ...
      videoColumn: "relative h-96 lg:h-screen order-2 lg:order-2",
  ...
  layoutContract: {
    ...
    breakpoints: {
      mobile: "single-col",
      tablet: "split-newsletter-video",
      desktop: "split-newsletter-video"
    }
  },
  ...
  accessibility: {
    ...
    screenReaderHints: {
      ...
      section: "Main hero content with newsletter signup and video"
    }
  },
  ...
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/07 - Split with Newsletter and Video",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_07Props, type ColorOverrides } from './Hero_07.types';",
      "import { validateHero07Props, sanitizeProps, formatValidationMessage } from './Hero_07.validators';",
      "import meta from './Hero_07.meta';"
    ],
    template: `const Hero_07: React.FC<Hero_07Props> = (props = {}) => {
    ...
    return (
        <section
            ...
            role="banner"
            aria-label="Main hero content with newsletter signup and video"
        >
  ...
  development: {
    ...
    documentation: {
      designNotes: "Lead capture component for landing pages with integrated newsletter signup and video player. All styles are tokenized using native HTML elements. Fully independent with no component dependencies.",
      usageGuidelines: "Use native h1, p, form, input, button, video elements with complete token classes. Colors are fully customizable via props. Animations can be disabled for accessibility. No external component dependencies. Newsletter form and video player integrated directly."
    }
  }
};
