...
// === Token Structure ===
export interface Hero_15Tokens {
    // Layout Structure - Content left bottom, heading right top
    layout: {
        section: string;
        ...
        leftColumn: string;
        rightColumn: string;
        leftContent: string; // Different from Hero_14 - left has content
        rightContent: string; // Different from Hero_14 - right has title
    };
...
// === Defaults ===
export interface Hero_15Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_15PropsSchema = {
    [K in keyof Required<Hero_15Props>]: PropDefinition<Hero_15Props[K]>;
};

// === Meta ===
export interface Hero_15Meta extends MetaV1_1<Hero_15Defaults, Hero_15Tokens> {
    component_id: "Hero_15";
    category: "hero";
    intent: "brand_awareness";
    layout_structure: "video_background_content_left_bottom_title_right_top";
    props: Hero_15PropsSchema;
    defaults: Hero_15Defaults;
    tokens: Hero_15Tokens;
    variants: Variant<Partial<Hero_15Props>, DeepPartial<Hero_15Tokens>>[];
}
...
export function isHero_15Props(obj: unknown): obj is Hero_15Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
// === Utility Types ===
export type Hero_15PropsKeys = keyof Hero_15Props;
export type Hero_15TokenKeys = keyof Hero_15Tokens;

export type Hero_15PropsPatch = Partial<Hero_15Props>;
export type Hero_15TokensPatch = DeepPartial<Hero_15Tokens>;

export interface ValidationResult<T = Hero_15Props> {
    valid: boolean;
    errors: string[];
    data?: T;
    warnings?: string[];
...
export type SanitizedHero_15Props = Required<Hero_15Props>;

export interface Hero_15BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_15GenerationContext {
    props: Partial<Hero_15Props>;
    tokens: Partial<Hero_15Tokens>;
    brand: Hero_15BrandContext;
    layout?: "content_left_title_right" | "centered";
    variant?: string;
