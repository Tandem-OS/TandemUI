/**
 * Color configuration for Hero_15 with Video background support
 */
export interface Hero_15Colors {
...
export interface Hero_15Props {
    ...
    colors?: Hero_15Colors;
}

/**
 * Default color configuration for Hero_15
 */
export const defaultColors: Hero_15Colors = {
    overlay: {
