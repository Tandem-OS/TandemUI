...
export function validateHero15Props(props: Hero_15Props): ValidationResult {
...
export function sanitizeProps(props: Hero_15Props): Hero_15Props {
...
export function validateLayoutSafety(props: Hero_15Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
