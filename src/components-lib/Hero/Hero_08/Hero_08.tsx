...
// Main Hero_08 component
const Hero_08: React.FC<Hero_08Props> = (props = {}) => {
    ...
    if (process.env.NODE_ENV === 'development') {
        if (!validation.valid || validation.warnings) {
            console.group('Hero_08 Validation');
    ...
    return (
        <section
            ...
            role="banner"
            aria-label={meta.accessibility.screenReaderHints?.section || "Main hero content with video on left and newsletter signup"}
            id={uniqueId}
        >
            <div className={meta.tokens.layout.wrapper}>
                ...
                >
                    ...
                    {/* Newsletter+Content Column - RIGHT SIDE */}
                    <MotionWrapper
