// src/components-lib/Hero/Hero_08/Hero_08.types.ts

/**
 * Color configuration for Hero_08 with Newsletter and Video support
 */
export interface Hero_08Colors {
  background?: {
    light?: string;
    dark?: string;
  };
...
export interface Hero_08Props {
  ...
  colors?: Hero_08Colors;
}

/**
 * Default color configuration for Hero_08
 */
export const defaultColors: Hero_08Colors = {
  background: {
    light: '#ffffff',
    dark: '#0f172a'
  },
