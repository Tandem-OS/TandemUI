// Hero_26.meta.ts
import { type Hero_26Meta } from './Hero_26.types';

const meta: Hero_26Meta = {
  version: "1.1",
  ...
  layout_structure: "left_aligned_content_above_video_with_newsletter",

  // === Tokens ===
  tokens: {
    // Layout Structure - Left Aligned Content Above Video with Newsletter
    layout: {
      section: "relative w-full",
      wrapper: "w-full",
      contentContainer: "container mx-auto text-left", // text-left for left alignment
    ...
    spacing: {
      ...
      contentSpacing: "space-y-md lg:space-y-lg max-w-3xl", // max-w-3xl for left alignment
  ...
  accessibility: {
    ...
    screenReaderHints: {
      ...
      section: "Main hero content with left-aligned content and newsletter above video"
    }
  },
  ...
  // === Semantic Profile ===
  semanticProfile: {
    primaryConcepts: ["lead-capture", "newsletter-signup", "video-content", "left-aligned-content", "business-focused"],
    ...
    contextualRelevance: ["landing-page-entry", "lead-generation", "newsletter-signup", "video-marketing"]
  },

  // === Figma Export ===
  figma: {
    autoLayout: true,
    figmaComponentName: "Hero/26 - Left Aligned Content Above Video with Newsletter",
    componentSets: {
  ...
  code: {
    ...
    imports: [
      ...
      "import { type Hero_26Props, type ColorOverrides } from './Hero_26.types';",
      "import { validateHero26Props, sanitizeProps, formatValidationMessage } from './Hero_26.validators';",
      "import meta from './Hero_26.meta';"
    ],
    template: `const Hero_26: React.FC<Hero_26Props> = (props = {}) => {
    ...
    return (
        <section
            ...
            role="banner"
            aria-label="Main hero content with left-aligned content and newsletter above video"
        >
  ...
  development: {
    ...
    documentation: {
      designNotes: "Lead-capture focused component for landing pages with left-aligned content and newsletter signup above full-width video. All styles are tokenized using native HTML elements. Fully independent with no component dependencies.",
