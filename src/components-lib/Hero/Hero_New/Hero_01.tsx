...
const Hero_01: React.FC<Hero_01Props> = (props = {}) => {
  ...
  // Secondary CTA - Show by default unless explicitly set to undefined
  const hasSecondaryCTA = sanitized.secondaryCTA !== undefined || !('secondaryCTA' in sanitized);
  const secondaryCTA = hasSecondaryCTA ? {
    text: sanitized.secondaryCTA?.text || "Learn More",
    href: sanitized.secondaryCTA?.href || "/learn",
  ...
  const imageAlt = typeof image === 'object' ? (image.alt || "Hero image") : "Hero image";
          ...
          <div className="xl:max-w-lg space-y-md lg:space-y-lg">
            ...
            <motion.div {...getAnimationProps(fadeInUp, 0, 0, animated)}>
              <Heading
                level="h1"
                weight="bold"
                className="text-h2-sm lg:text-h1-md font-bold"
                style={styles.title}
              >
                {title}
              </Heading>
            ...
            <motion.div {...getAnimationProps(fadeInUp, 0.1, 0, animated)}>
              <Para
                size="md"
                className="text-para-md lg:text-para-lg leading-relaxed"
