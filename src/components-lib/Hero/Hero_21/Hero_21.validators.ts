...
export function validateHero21Props(props: Hero_21Props): ValidationResult {
...
export function sanitizeProps(props: Hero_21Props): Hero_21Props {
...
export function validateLayoutSafety(props: Hero_21Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
