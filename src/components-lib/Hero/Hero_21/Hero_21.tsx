...
import { type Hero_21Props, defaultColors } from './Hero_21.types';
...
const useComponentStyles = (colors: Hero_21Props['colors'], theme: 'light' | 'dark') => {
    return useMemo(() => {
...
/**
 * Hero_21 Component - Left aligned content above full-width image
 */
const Hero_21: React.FC<Hero_21Props> = ({
        ...
        >
            ...
            <div className="container mx-auto px-lg py-2xl lg:py-4xl">
                ...
                >
                    ...
                    <div className="flex items-center justify-start gap-md pt-sm">
                        <ActionButton
                            cta={primaryCta}
