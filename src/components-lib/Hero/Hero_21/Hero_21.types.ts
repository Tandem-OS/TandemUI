/**
 * Color configuration for Hero_21
 */
export interface Hero_21Colors {
    background?: {
        light?: string;
        dark?: string;
    };
...
export interface Hero_21Props {
    ...
    colors?: Hero_21Colors;
}

/**
 * Default color configuration for Hero_21
 */
export const defaultColors: Hero_21Colors = {
    background: {
        light: '#ffffff',
        dark: '#0f172a'
    },
