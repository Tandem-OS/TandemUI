...
// === Token Structure ===
export interface Hero_21Tokens {
...
// === Defaults ===
export interface Hero_21Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_21PropsSchema = {
    [K in keyof Required<Hero_21Props>]: PropDefinition<Hero_21Props[K]>;
};

// === Meta ===
export interface Hero_21Meta extends MetaV1_1<Hero_21Defaults, Hero_21Tokens> {
    component_id: "Hero_21";
    category: "hero";
    intent: "convert";
    layout_structure: "left_aligned_content_above_image";
    props: Hero_21PropsSchema;
    defaults: Hero_21Defaults;
    tokens: Hero_21Tokens;
    variants: Variant<Partial<Hero_21Props>, DeepPartial<Hero_21Tokens>>[];
}
...
export function isHero_21Props(obj: unknown): obj is Hero_21Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
// === Utility Types ===
export type Hero_21PropsKeys = keyof Hero_21Props;
export type Hero_21TokenKeys = keyof Hero_21Tokens;

export type Hero_21PropsPatch = Partial<Hero_21Props>;
export type Hero_21TokensPatch = DeepPartial<Hero_21Tokens>;

export interface ValidationResult<T = Hero_21Props> {
    valid: boolean;
    errors: string[];
    data?: T;
    warnings?: string[];
...
export type SanitizedHero_21Props = Required<Hero_21Props>;

export interface Hero_21BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_21GenerationContext {
    props: Partial<Hero_21Props>;
    tokens: Partial<Hero_21Tokens>;
    brand: Hero_21BrandContext;
