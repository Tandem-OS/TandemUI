...
export function validateHero03Props(props: Hero_03Props): ValidationResult {
...
export function sanitizeProps(props: Hero_03Props): Hero_03Props {
...
export function validateLayoutSafety(props: Hero_03Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
