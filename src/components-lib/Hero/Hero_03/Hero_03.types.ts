// src/components-lib/Hero/Hero_03/Hero_03.types.ts

/**
 * Color configuration for Hero_03 with Newsletter support
 */
export interface Hero_03Colors {
  background?: {
    light?: string;
    dark?: string;
  };
...
export interface Hero_03Props {
  ...
  colors?: Hero_03Colors;
}

/**
 * Default color configuration for Hero_03
 */
export const defaultColors: Hero_03Colors = {
  background: {
    light: '#ffffff',
    dark: '#0f172a'
  },
