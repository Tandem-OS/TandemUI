...
import { type Hero_18Props, defaultColors } from './Hero_18.types';
...
const useComponentStyles = (colors: Hero_18Props['colors'], theme: 'light' | 'dark') => {
    return useMemo(() => {
 ...
 * Hero_18 Component
 */
const Hero_18: React.FC<Hero_18Props> = ({
        ...
        <section className={`relative w-full min-h-screen lg:h-screen overflow-hidden ${className}`}>
            ...
            <div className="relative z-10 w-full h-full min-h-screen lg:h-screen py-md lg:py-2xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 h-[95vh] lg:h-full">
                    ...
                    {/* Left Column - Paragraph (Desktop: Bottom, Mobile: Bottom) */}
                    <div className="order-2 lg:order-1 flex items-end px-lg pb-sm lg:pb-xl lg:px-2xl xl:px-3xl 2xl:px-4xl pt-sm lg:pt-xl">
                        <motion.div
                            className="w-full"
                    ...
                    {/* Right Column - Heading & CTAs (Desktop: Center, Mobile: Top) */}
                    <div className="order-1 lg:order-2 flex lg:items-center px-lg pb-sm lg:pb-xl lg:px-xl xl:px-2xl 2xl:px-4xl pt-sm lg:pt-xl">
                        <motion.div
                            className="w-full space-y-md lg:space-y-lg lg:ml-2xl"
