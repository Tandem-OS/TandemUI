...
// === Token Structure ===
export interface Hero_18Tokens {
    // Layout Structure - Paragraph left bottom, heading & CTAs right center
    layout: {
        section: string;
        ...
        leftColumn: string;
        rightColumn: string;
        leftContent: string; // Paragraph styling for left column
        rightContent: string; // Heading & CTAs styling for right column
    };
...
// === Defaults ===
export interface Hero_18Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_18PropsSchema = {
    [K in keyof Required<Hero_18Props>]: PropDefinition<Hero_18Props[K]>;
};

// === Meta ===
export interface Hero_18Meta extends MetaV1_1<Hero_18Defaults, Hero_18Tokens> {
    component_id: "Hero_18";
    category: "hero";
    intent: "conversion";
    layout_structure: "video_background_paragraph_left_bottom_heading_cta_right_center";
    props: Hero_18PropsSchema;
    defaults: Hero_18Defaults;
    tokens: Hero_18Tokens;
    variants: Variant<Partial<Hero_18Props>, DeepPartial<Hero_18Tokens>>[];
}
...
export function isHero_18Props(obj: unknown): obj is Hero_18Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
// === Utility Types ===
export type Hero_18PropsKeys = keyof Hero_18Props;
export type Hero_18TokenKeys = keyof Hero_18Tokens;

export type Hero_18PropsPatch = Partial<Hero_18Props>;
export type Hero_18TokensPatch = DeepPartial<Hero_18Tokens>;

export interface ValidationResult<T = Hero_18Props> {
    valid: boolean;
    errors: string[];
    data?: T;
    warnings?: string[];
...
export type SanitizedHero_18Props = Required<Hero_18Props>;

export interface Hero_18BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_18GenerationContext {
    props: Partial<Hero_18Props>;
    tokens: Partial<Hero_18Tokens>;
    brand: Hero_18BrandContext;
    layout?: "paragraph_left_bottom_heading_cta_right_center" | "centered";
    variant?: string;
