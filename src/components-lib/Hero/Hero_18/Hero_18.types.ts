/**
 * Color configuration for Hero_18 with Video background support
 */
export interface Hero_18Colors {
...
export interface Hero_18Props {
    ...
    colors?: Hero_18Colors;
}

/**
 * Default color configuration for Hero_18
 */
export const defaultColors: Hero_18Colors = {
    overlay: {
