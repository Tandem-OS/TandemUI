...
export function validateHero06Props(props: Hero_06Props): ValidationResult {
...
export function sanitizeProps(props: Hero_06Props): Hero_06Props {
...
export function validateLayoutSafety(props: Hero_06Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
