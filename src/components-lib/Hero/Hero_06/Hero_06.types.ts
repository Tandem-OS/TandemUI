...
// === Token Structure - Updated with Video Tokens (Video Left Layout) ===
export interface Hero_06Tokens {
    ...
    layout: {
        ...
        contentColumn: string; // Content on right side
...
export interface Hero_06Defaults {
    title: string;
    description: string;
    primaryCTA: {
        text: string;
...
// === Props Schema ===
export type Hero_06PropsSchema = {
    [K in keyof Required<Hero_06Props>]: PropDefinition<Hero_06Props[K]>;
};

// === Meta ===
export interface Hero_06Meta extends MetaV1_1<Hero_06Defaults, Hero_06Tokens> {
    component_id: "Hero_06";
    category: "hero";
    intent: "convert";
    layout_structure: "split-video-left";
    props: Hero_06PropsSchema;
    defaults: Hero_06Defaults;
    tokens: Hero_06Tokens;
    variants: Variant<Partial<Hero_06Props>, DeepPartial<Hero_06Tokens>>[];
}
...
export function isHero_06Props(obj: unknown): obj is Hero_06Props {
    if (!obj || typeof obj !== "object") return false;
    const o = obj as Record<string, unknown>;
...
export type Hero_06PropsKeys = keyof Hero_06Props;
export type Hero_06TokenKeys = keyof Hero_06Tokens;

// For variant creation
export type Hero_06PropsPatch = Partial<Hero_06Props>;
export type Hero_06TokensPatch = DeepPartial<Hero_06Tokens>;

// For validation results
export interface ValidationResult<T = Hero_06Props> {
    valid: boolean;
    errors: string[];
    data?: T;
}
...
// For sanitized props
export type SanitizedHero_06Props = Required<Hero_06Props>;

// Brand context for AI generation
export interface Hero_06BrandContext {
    industry: string;
    personality: string;
    positioning: string;
...
export interface Hero_06GenerationContext {
    props: Partial<Hero_06Props>;
    tokens: Partial<Hero_06Tokens>;
    brand: Hero_06BrandContext;
    layout?: "video-left" | "video-right" | "centered";
    variant?: string;
