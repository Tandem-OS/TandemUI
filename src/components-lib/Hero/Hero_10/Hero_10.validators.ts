...
export function validateHero10Props(props: Hero_10Props): ValidationResult {
...
export function sanitizeProps(props: Hero_10Props): Hero_10Props {
...
export function validateLayoutSafety(props: Hero_10Props): { safe: boolean; warnings: string[] } {
    const warnings: string[] = [];
