...
// Main Hero_10 component
const Hero_10: React.FC<Hero_10Props> = (props = {}) => {
    ...
    if (process.env.NODE_ENV === 'development') {
        if (!validation.valid || validation.warnings) {
            console.group('Hero_10 Validation');
    ...
    return (
        <section
            ...
            role="banner"
            aria-label={meta.accessibility.screenReaderHints?.section || "Main hero content with responsive layout"}
            id={uniqueId}
        >
            {/* Background Image */}
            <div
            ...
            <div className={`${meta.tokens.layout.contentContainer} ${meta.tokens.spacing.sectionY}`}>
                <div className={meta.tokens.layout.grid}>
                    ...
                    <div className={meta.tokens.layout.leftColumn} data-testid="hero-left-column">
                        ...
                        <MotionWrapper
                            className={meta.tokens.layout.desktopContentWrapper}
                            {...(animated ? getAnimationProps(fadeInUp, 0.1, 0, true) : {})}
                            data-testid="hero-desktop-content"
                        >
                            {/* Description */}
                            <p
                    ...
                    <div className={meta.tokens.layout.rightColumn} data-testid="hero-right-column">
                        {/* Mobile Content (visible on mobile only) */}
                        <MotionWrapper
                            className={meta.tokens.layout.mobileContentWrapper}
                            {...(animated ? getAnimationProps(fadeInUp, 0.1, 0, true) : {})}
                            data-testid="hero-mobile-content"
                        >
                            {/* Description */}
                            <p
                                className={meta.tokens.typography.body.complete}
