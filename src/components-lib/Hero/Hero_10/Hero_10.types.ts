/**
 * Color configuration for Hero_10 - Background hero with overlay
 */
export interface Hero_10Colors {
...
export interface Hero_10Props {
  ...
  colors?: Hero_10Colors;
}

/**
 * Default color configuration for Hero_10
 */
export const defaultColors: Hero_10Colors = {
  overlay: {
