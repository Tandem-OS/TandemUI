...
import { faqSlotToProps } from './FAQSlotsToProps'
import { faqTokensToStyles } from './FAQTokensToColors'
...
const FAQBase: React.FC<FAQBaseProps> = ({ section }) => {
    ...
    const Shell = resolveFAQLayout(section.layout_structure ?? 'accordion')
