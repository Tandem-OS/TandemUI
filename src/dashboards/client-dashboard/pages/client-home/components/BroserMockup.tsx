...
const BrowserMockup: React.FC = () => {
    return (
        ...
        >
            ...
            {/* Browser Content */}
            <div className="flex-1 bg-gradient-to-br from-background-secondary via-background-muted to-background-secondary rounded-b-xl sm:rounded-b-2xl p-6 sm:p-8 lg:p-12 flex items-center justify-center relative overflow-hidden">
                <motion.div
