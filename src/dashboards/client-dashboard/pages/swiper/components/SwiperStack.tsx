...
const SwiperStack: React.FC<SwiperStackProps> = ({
    ...
    const getStackConfig = (stackIndex: number, totalInStack: number) => {
        ...
        switch (relativeIndex) {
            case 0: // Front card
                return { scale: 1, zIndex: 50, y: 0, opacity: 1 };
            case 1: // Second card
                return { scale: 0.92, zIndex: 40, y: 25, opacity: 1 };
            case 2: // Third card
                return { scale: 0.84, zIndex: 30, y: 50, opacity: 1 };
            default: // Cards further back
                return { scale: 0.76, zIndex: 20, y: 75, opacity: 0 };
        }
    };
    ...
    return (
        <div className="relative w-full max-w-4xl 2xl:max-w-6xl mx-auto">
